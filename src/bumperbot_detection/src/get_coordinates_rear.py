...
class BallDetector:
    def __init__(self):
        ...
        detected_object_coordinates_topic_pub_ = rospy.get_param('/litter_detection/topics/detected_object_coordinates_rear_camera')
        camera_color_image_raw_client = rospy.get_param('/camera/topics/color_image_rear_raw')
        camera_depth_image_raw_client = rospy.get_param('/camera/topics/depth_image_rear_raw')
        ...
        self.camera_frame = rospy.get_param('~camera_frame', 'rear_dpcamera_link')
...
if __name__ == "__main__":
    rospy.init_node('rear_ball_detector', anonymous=True)
